...
@:native("timer") extern class Timer {
	...
	@:native("frametime") public static function frametime():Void;
	//  SHARED
	/*  Adjusts a timer */
	...
	@:native("systime") public static function systime():Void;
	//  SHARED
	...
	@:native("curtime") public static function curtime():Void;
	//  SHARED
	/*  Unpauses a timer */
	...
	@:native("realtime") public static function realtime():Void;
	//  SHARED
	/*  Stops a timer */

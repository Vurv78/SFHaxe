...
@:native("game") extern class Game {
	...
	**/
	#if CLIENT @:native("getSunInfo") public static function getSunInfo():Any;#end
	/**
		SHARED
	...
	**/
	#if CLIENT @:native("isSkyboxVisibleFromPoint") public static function isSkyboxVisibleFromPoint(position:Any):Any;#end
	/**
		SHARED
	...
	**/
	#if SERVER @:native("blastDamage") public static function blastDamage(damageOrigin:Any, damageRadius:Any, damage:Any):Void;#end
	/**
		SHARED
	...
	**/
	#if CLIENT @:native("hasFocus") public static function hasFocus():Any;#end
}

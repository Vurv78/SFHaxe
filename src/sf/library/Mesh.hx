...
@:native("mesh") extern class Mesh {
	...
	**/
	@:native("generateNormals") public static function generateNormals(vertices:lua.Table<Dynamic,Dynamic>, ?inverted:Null<Bool>, ?smooth:Null<Float>):Void;
	/**
		CLIENT
	...
	**/
	#if CLIENT @:native("generate") public static function generate(?mesh:Null<sf.type.Mesh>, prim:Float, prim:Float, func:haxe.Constraints.Function):Void;#end
	/**
		CLIENT

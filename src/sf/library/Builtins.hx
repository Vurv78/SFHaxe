...
@:native("_G") extern class Builtins {
	...
	**/
	#if CLIENT @:native("WebSocket") public static function WebSocket(addr:std.String, ?port:Null<Float>, ?secure:Null<Bool>):sf.type.WebSocket;#end
	/**
		SHARED
	...
	**/
	@:native("unpack") public static function unpack(tbl:lua.Table<Dynamic,Dynamic>, ?startIndex:Null<Float>, ?endIndex:Null<Float>):Dynamic;
	/**
		SHARED
	...
	**/
	@:native("getScripts") public static function getScripts(?ent:Null<sf.type.Entity>):lua.Table<Dynamic,Dynamic>;
	/**
		SHARED
		Returns a new VMatrix
	**/
	@:native("Matrix") public static function Matrix(t:Any, v:Any):sf.type.VMatrix;
	/**
		SHARED
		Runs an included script and caches the result.
		Works pretty much like standard Lua require()
	**/
	@:native("requiredir") public static function requiredir(path:std.String, loadpriority:lua.Table<Dynamic,Dynamic>):lua.Table<Dynamic,Dynamic>;
	/**
		SHARED
		Runs an included script and caches the result.
		Works pretty much like standard Lua require()
	**/
	@:native("require") public static function require(path:std.String):Dynamic;
	/**
		CLIENT
	...
	**/
	@:native("isbool") public static function isbool(x:Any):Bool;
	/**
		SHARED
	...
	**/
	@:native("isfunction") public static function isfunction(x:Any):Bool;
	/**
		CLIENT
	...
	**/
	@:native("hasPermission") public static function hasPermission(perm:std.String, obj:Any):Bool;
	/**
		SERVER
	...
	**/
	@:native("dofile") public static function dofile(path:std.String):Dynamic;
	/**
		SHARED
		Runs an included directory, but does not cache the result.
	**/
	@:native("dodir") public static function dodir(path:std.String, loadpriority:lua.Table<Dynamic,Dynamic>):lua.Table<Dynamic,Dynamic>;
	/**
		SHARED
	...
	**/
	@:native("isstring") public static function isstring(x:Any):Bool;
	/**
		CLIENT
	...
	**/
	@:native("isnumber") public static function isnumber(x:Any):Bool;
	/**
		SHARED
		Returns whoever created the chip
	**/
	@:native("owner") public static function owner():sf.type.Player;
	/**
		SHARED
	...
	**/
	@:native("istable") public static function istable(x:Any):Bool;
	/**
		SHARED
		Sets the chip to allow other chips to view its sources
	**/
	@:native("shareScripts") public static function shareScripts(enable:Bool):Void;
	/**
		SHARED
		Prints a message to the player's console.
	**/
	@:native("printConsole") public static function printConsole(printArgs:Dynamic):Void;
	/**
		SHARED
	...
	**/
	#if SERVER @:native("Vector2") public static function Vector2(x:Float, y:Float):Any;#end
	/**
		SHARED

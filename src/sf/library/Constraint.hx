...
@:native("constraint") extern class Constraint {
	...
	**/
	#if SERVER @:native("rope") public static function rope(index:Float, e1:sf.type.Entity, e2:sf.type.Entity, ?bone1:Null<Float>, ?bone2:Null<Float>, v1:sf.type.Vector, v2:sf.type.Vector, ?length:Null<Float>, ?addlength:Null<Float>, ?force:Null<Float>, ?width:Null<Float>, ?materialName:Null<std.String>, ?rigid:Null<Bool>):Void;#end
	/**
		SERVER
		 Ballsocket two entities together. For more options, see constraint.ballsocketadv
	**/
	#if SERVER @:native("ballsocket") public static function ballsocket(e1:sf.type.Entity, e2:sf.type.Entity, ?bone1:Null<Float>, ?bone2:Null<Float>, pos:sf.type.Vector, ?force:Null<Float>, ?torque:Null<Float>, ?nocollide:Null<Bool>):Void;#end
	/**
		SERVER
	...
	**/
	#if SERVER @:native("ballsocketadv") public static function ballsocketadv(e1:sf.type.Entity, e2:sf.type.Entity, ?bone1:Null<Float>, ?bone2:Null<Float>, v1:sf.type.Vector, v2:sf.type.Vector, ?force:Null<Float>, ?torque:Null<Float>, ?minv:Null<sf.type.Vector>, ?maxv:Null<sf.type.Vector>, ?frictionv:Null<sf.type.Vector>, ?rotateonly:Null<Bool>, ?nocollide:Null<Bool>):Void;#end
	/**
		SERVER
	...
	**/
	#if SERVER @:native("axis") public static function axis(e1:sf.type.Entity, e2:sf.type.Entity, ?bone1:Null<Float>, ?bone2:Null<Float>, v1:sf.type.Vector, v2:sf.type.Vector, ?force:Null<Float>, ?torque:Null<Float>, ?friction:Null<Float>, ?nocollide:Null<Bool>, ?laxis:Null<sf.type.Vector>):Void;#end
	/**
		SERVER
	...
	**/
	...
	/**
		SERVER
		 Welds two entities
	**/
	#if SERVER @:native("weld") public static function weld(e1:sf.type.Entity, e2:sf.type.Entity, ?bone1:Null<Float>, ?bone2:Null<Float>, ?force:Null<Float>, ?nocollide:Null<Bool>):Void;#end
	/**
		SERVER

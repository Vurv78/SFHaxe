...
extern class EntityData {
	...
	**/
	@:native("isKeysOwned") public function isKeysOwned():Bool;
	/**
		SHARED
	...
	**/
	@:native("getKeysTitle") public function getKeysTitle():Null<std.String>;
	/**
		SHARED
	...
	**/
	@:native("getNoDraw") public function getNoDraw():Bool;
	/**
		CLIENT
	...
	**/
	@:native("getDoorOwner") public function getDoorOwner():Null<sf.type.Player>;
	/**
		SERVER
		Removes an entity
	**/
	...
	**/
	@:native("worldToLocalVector") public function worldToLocalVector(data:sf.type.Vector):sf.type.Vector;
	/**
		SHARED
	...
	**/
	@:native("getBodygroupCount") public function getBodygroupCount(id:Float):Float;
	/**
		SHARED
	...
	**/
	@:native("isDormant") public function isDormant():Bool;
	/**
		SHARED
		Gets the name of a sequence
	**/
	@:native("getSequenceName") public function getSequenceName(id:Float):std.String;
	/**
		SHARED
	...
	**/
	@:native("getBoundingRadius") public function getBoundingRadius():Float;
	/**
		SHARED
		Gets the velocity of the entity in its local coordinate system
	**/
	@:native("getLocalVelocity") public function getLocalVelocity():sf.type.Vector;
	/**
		CLIENT
	...
	**/
	@:native("localToWorldVector") public function localToWorldVector(data:sf.type.Vector):sf.type.Vector;
	/**
		SERVER
	...
	**/
	@:native("getNearestPoint") public function getNearestPoint(The:sf.type.Vector):sf.type.Vector;
	/**
		SHARED
	...
	**/
	#if SERVER @:native("isLocked") public function isLocked():Bool;#end
	/**
		CLIENT
	...
	**/
	@:native("getAmount") public function getAmount():Null<Float>;
	/**
		SHARED
	...
	**/
	@:native("getCount") public function getCount():Null<Float>;
	/**
		SHARED
	...
	**/
	@:native("getShipmentContents") public function getShipmentContents():Null<lua.Table<Dynamic,Dynamic>>;
	/**
		SHARED
	...
	**/
	@:native("getSaveTable") public function getSaveTable(showAll:Bool):lua.Table<Dynamic,Dynamic>;
	/**
		SHARED
	...
	**/
	@:native("getSequenceCount") public function getSequenceCount():Float;
	/**
		SHARED
	...
	**/
	@:native("getSequenceInfo") public function getSequenceInfo(id:Float):lua.Table<Dynamic,Dynamic>;
	/**
		SERVER
	...
	**/
	#if SERVER @:native("enableSphere") public function enableSphere(enabled:Bool, ?radius:Null<Float>):Void;#end
	/**
		SHARED
	...
	**/
	@:native("isKeysOwnedBy") public function isKeysOwnedBy(ply:sf.type.Player):Bool;
	/**
		SHARED
	...
	**/
	#if SERVER @:native("doorIndex") public function doorIndex():Null<Float>;#end
	/**
		SHARED
	...
	**/
	@:native("isSequenceFinished") public function isSequenceFinished():Bool;
	/**
		SERVER
	...
	**/
	@:native("getSequenceList") public function getSequenceList():lua.Table<Dynamic,Dynamic>;
	/**
		SERVER
	...
	**/
	@:native("isMoneyBag") public function isMoneyBag():Bool;
	/**
		SERVER
	...
	**/
	@:native("setParent") public function setParent(?parent:Null<sf.type.Entity>, number:Any, number:Any):Void;
	/**
		SHARED
	...
	**/
	@:native("getInternalVariable") public function getInternalVariable(variableName:std.String):Any;
	/**
		SHARED
	...
	**/
	@:native("isDoor") public function isDoor():Bool;
	/**
		SHARED
	...
	**/
	@:native("getShipmentContentsIndex") public function getShipmentContentsIndex():Null<Float>;
	/**
		SHARED
	...
	**/
	...
	/**
		SERVER
		eturns if the entity is a constraint.
	**/

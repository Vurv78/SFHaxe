...
extern class ParticleEmitterData {
	...
	**/
	#if CLIENT @:native("setBBox") public function setBBox(mins:Any, maxs:Any):Void;#end
	/**
		CLIENT
		 Returns whether this emitter is 3D or not. This is set when creating the emitter with ParticleEmitter.
	**/
	#if CLIENT @:native("is3D") public function is3D():Any;#end
	/**
		CLIENT
	...
	**/
	#if CLIENT @:native("setParticleCullRadius") public function setParticleCullRadius(radius:Any):Void;#end
	/**
		CLIENT
		 Returns number of particles left able to be created from the emitter
	**/
	#if CLIENT @:native("getParticlesLeft") public function getParticlesLeft():Any;#end
	/**
		CLIENT
	...
	**/
	#if CLIENT @:native("setNoDraw") public function setNoDraw(noDraw:Any):Void;#end
	/**
		CLIENT
		 Sets the position of the particle emitter.
	**/
	#if CLIENT @:native("setPos") public function setPos(position:Any):Void;#end
	/**
		CLIENT
	...
	**/
	#if CLIENT @:native("getNumActiveParticles") public function getNumActiveParticles():Any;#end
	/**
		CLIENT
		 Creates a new Particle with the given material and position.
	**/
	#if CLIENT @:native("add") public function add(material:Any, position:Any, startSize:Any, endSize:Any, startLength:Any, endLength:Any, startAlpha:Any, endAlpha:Any, dieTime:Any):Any;#end
	/**
		CLIENT
	...
	**/
	#if CLIENT @:native("setNearClip") public function setNearClip(distanceMin:Any, distanceMax:Any):Void;#end
	/**
		CLIENT

...
extern class HologramData {
	...
	**/
	#if SERVER @:native("setAngVel") public function setAngVel(angvel:Any):Void;#end
	/**
		SHARED
		 Animates a hologram
	**/
	...
	**/
	#if SERVER @:native("setVel") public function setVel(vel:Any):Void;#end
	/**
		SHARED
	...
	**/
	#if CLIENT @:native("setFilterMag") public function setFilterMag(val:Any):Void;#end
	/**
		SHARED
	...
	**/
	#if CLIENT @:native("setRenderMatrix") public function setRenderMatrix(mat:Any):Void;#end
	/**
		SHARED
	...
	**/
	#if CLIENT @:native("setFilterMin") public function setFilterMin(val:Any):Void;#end
}

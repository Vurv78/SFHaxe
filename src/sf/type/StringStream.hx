...
extern class StringStreamData {
	...
	**/
	@:native("readEntity") public function readEntity(?callback:Null<haxe.Constraints.Function>):sf.type.Entity;
	/**
		SHARED
	...
	**/
	@:native("writeEntity") public function writeEntity(e:sf.type.Entity):Void;
	/**
		SHARED

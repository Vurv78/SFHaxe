...
extern class PhysObjData {
	...
	**/
	@:native("getSurfaceArea") public function getSurfaceArea():Null<Float>;
	/**
		SHARED
	...
	**/
	@:native("isMoveable") public function isMoveable():Bool;
	/**
		SERVER
	...
	**/
	#if SERVER @:native("getStress") public function getStress():Float;#end
	/**
		SHARED

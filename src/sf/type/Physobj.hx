...
extern class PhysObjData {
	...
	**/
	#if SERVER @:native("setPos") public function setPos(pos:Any):Void;#end
	/**
		SHARED
	...
	**/
	#if SERVER @:native("setBuoyancyRatio") public function setBuoyancyRatio(ratio:Any):Void;#end
	/**
		SHARED
	...
	**/
	#if SERVER @:native("isAsleep") public function isAsleep():Any;#end
	/**
		SERVER
	...
	**/
	#if SERVER @:native("getFrictionSnapshot") public function getFrictionSnapshot():Any;#end
	/**
		SHARED
	...
	**/
	#if SERVER @:native("applyForceCenter") public function applyForceCenter(force:Any):Void;#end
	/**
		SHARED
	...
	**/
	#if SERVER @:native("setInertia") public function setInertia(inertia:Any):Void;#end
	/**
		SERVER
